...
export default function ChangePasswordForm() {
  ...
  return (
    <form action={formAction} className="space-y-4">
      <div>
        <label className="mb-1.5 block text-sm font-medium text-emerald-50/80">New password</label>
      ...
      <div>
        <label className="mb-1.5 block text-sm font-medium text-emerald-50/80">Confirm new password</label>
        <div className="relative">
          <span className="pointer-events-none absolute left-3 top-1/2 -translate-y-1/2 text-emerald-100/35">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
              <rect x="5" y="11" width="14" height="9" rx="2" stroke="currentColor" strokeWidth="1.6" />
